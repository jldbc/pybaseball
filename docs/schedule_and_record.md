...
__schedule_and_record(season, team)__
...
## Arguments
__season:__ Integer. The season for which you want a team's record data. 

__team:__ String. The abbreviation of the team for which you are requesting data (e.g. "PHI", "BOS", "LAD"). 
