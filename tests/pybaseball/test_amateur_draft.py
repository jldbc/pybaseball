...
from pybaseball.amateur_draft import amateur_draft, _URL
...
def _sample_processed_result_no_stats(get_data_file_dataframe: Callable) -> pd.DataFrame:
...
def test_amateur_draft(response_get_monkeypatch: Callable, sample_html: str,
    ...
    expected_url = _URL.format(year=2019, round=1)
